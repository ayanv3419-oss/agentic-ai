...
_CATALOG: dict[str, Concept] = {c.name: c for c in (
    ...
    _c("department", "dimension",
       "dept", "div", "division", "section"),
    _c("warehouse", "dimension",
       "wh", "warehouse_name", "fulfillment_center", "fc"),
    _c("supplier", "dimension",
       "vendor", "supplier_name", "vendor_name", "manufacturer_id"),
    _c("launch_season", "dimension",
       "season", "release_season", "collection"),
    _c("inventory_status", "dimension",
       "stock_status", "availability", "stock_state"),
    _c("sales_channel", "dimension",
